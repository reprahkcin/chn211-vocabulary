...
// END TITLE ROW
    ...
    strokeGraphic.onclick = function() {swapStroke(objects[i].id)};
    ...
    playbtn.onclick = function() {playVideo( videoId )};
...
function swapStroke(id){
    ...
    switch (index < objects[characterIndex].strokePng.length) {
        case true:
            ...
            img.onclick = function() {swapStroke(id)};
            div.appendChild(img);
            index++;
            break;
        case false:
            ...
            strokeGraphic.setAttribute('src', './images/guide.png');
            strokeGraphic.setAttribute('class','stroke');
            strokeGraphic.onclick = function() {swapStroke(id)};
